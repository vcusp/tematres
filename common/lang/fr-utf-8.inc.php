...
define("TR_acronimo","TA");
define("TE_acronimo","TS");
define("TG_acronimo","TG");
define("UP_acronimo","EP");
...
define("LABEL_TipoLenguaje","Type de langage");
define("LABEL_Cobertura","Couverture");
define("LABEL_Terminos","termes");
define("LABEL_RelTerminos","relations entre les termes");
define("LABEL_TerminosUP","termes exclus");

define("LABEL_BuscaTermino","Rechercher un terme");
define("LABEL_Buscar","Rechercher");
define("LABEL_Enviar","Envoyer");
define("LABEL_Cambiar","Enregistrer les modifications");
define("LABEL_Anterior","précédent");
define("LABEL_AdminUser","Administration des utilisateurs");
define("LABEL_DatosUser","Information sur l'utilisateur");
define("LABEL_Acciones","Tâches réalisées");
define("LABEL_verEsquema","voir le schéma");
define("LABEL_actualizar","Mettre à jour");
define("LABEL_terminosLibres","Termes libres");
define("LABEL_busqueda","Recherche");
define("LABEL_borraRelacion","Enlever la relation");

define("MSG_ResultBusca","termes rencontrés lors de la recherche");
define("MSG_ResultLetra","Lettre");
define("MSG_ResultCambios","Modifications réussies.");
define("MSG_noUser","Utilisateur non enregistré");
define("FORM_JS_check","S'il vous plaît, vérifier les données de ");
define("FORM_JS_confirm","Etes-vous sûr de vouloir effacer le terme ou la relation ?");
...
define("LABEL_mail","courrier électronique");
define("LABEL_pass","mot de passe");
define("LABEL_repass","confirmer le mot de passe");
define("LABEL_orga","organisation");

define("LABEL_lcConfig","Configuration du thésaurus");
...
define("FORM_LABEL_Cobertura","couverture");
...
define("LABEL_EditorNota","Editeur de notes");
define("LABEL_EditorNotaTermino","Notes du terme ");
define("LABEL_tipoNota","type de note");
define("FORM_LABEL_tipoNota","type_note");
define("LABEL_nota","note");
define("FORM_LABEL_nota","_note");
define("LABEL_EliminarNota","Effacer une note");
...
define("LABEL_TotalUsuarios","Tous les utilisateurs");
define("LABEL_TotalTerminos","Tous les termes");
define("LABEL_ordenar","ranger par");
define("LABEL_auditoria","contrôle des termes");
define("LABEL_dia","jour");
define("LABEL_mes","mois");
define("LABEL_ano","année");
define("LABEL_terminosRepetidos","termes répétés");
define("MSG_noTerminosLibres","Il n'existe pas de termes libres");
define("MSG_noTerminosRepetidos","Il n'existe pas de termes répétés");
...
define("LABEL_SI","OUI");
define("LABEL_NO","NON");
define("FORM_LABEL_jeraquico","polyhierarchique");
define("LABEL_jeraquico","Polyhierarchique");
...
/* v 9.7 */
define("LABEL_export","exportation");
define("FORM_LABEL_format_export","sélectionner schéma XML");
...
define("LABEL_User_NoHabilitado","désactiver");
define("LABEL_User_Habilitado","activer");

// define("LABEL_CandidatearTermino","Candidatear término");
define("LABEL_CandidatearTermino","Terme candidat");
...
/* v 1.02 */
define("LABEL_esSuperUsuario","est Admin");
define("LABEL_Cancelar","Annuler");
define("LABEL_Guardar","Sauver");
...
define("HELP_variosTerminos","Pour ajouter plusieurs termes à la fois incarne <strong>un mot par ligne</strong>.");
...
$install_message[301] = "Woppsss... There is already an Tematres instance for the configuration. Please check your file configuration for the database connection (%s)." ;
...
define("IMPORT_form_legend","Importer un thesaurus indente") ;
define("IMPORT_form_label","Fichier") ;
define("IMPORT_file_already_exists","Un fichier txt est deja present sur le serveur") ;
define("IMPORT_file_not_exists","Aucun fichier a importer pour le moment") ;
