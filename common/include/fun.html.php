...
$body.='</div>';
$body.='<button type="button" class="btn btn-default" onclick="'."with(document.getElementById('resultwrapper').style){ visibility='visible'; display='inline'; } document.querySelector('#resultado').innerText = document.querySelector('#titulotermo').innerText + (document.querySelector('#qualificadorresposta').value.trim()=='' ? '':('\$\$x' + document.querySelector('#qualificadorresposta').value.trim())) + (document.querySelector('#generoresposta').value.trim()==''?'':('\$\$v' + document.querySelector('#generoresposta').value.trim())) + (document.querySelector('#dataresposta').value.trim()==''?'':('\$\$v' + document.querySelector('#dataresposta').value.trim())) + (document.querySelector('#geograficoresposta').value.trim()==''?'':('\$\$v' + document.querySelector('#geograficoresposta').value.trim())) + '\$\$2larpcal';".'">Gerar</button>';
$body.='<br/><div class="form-group" id="resultwrapper" style="visibility:hidden;display:none;">';
